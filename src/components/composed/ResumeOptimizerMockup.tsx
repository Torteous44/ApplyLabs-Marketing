...
const GaugeIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m-1 3v-1.5a2.25 2.25 0 0 0-2.25-2.25H15M12 9l-3 3m0 0 3 3m3-3H9" />
  </svg>
);
  ...
  return (
    <div className="relative h-full w-full flex flex-col p-1 md:p-3">
      ...
      <div className="mb-3">
        ...
        <div className="text-xs md:text-sm text-black/70 mb-1">jane.doe@email.com • +1 555 123 4567</div>
      </div>

      {/* Resume Section */}
      <div className="mb-3">
        <div className="text-sm md:text-base font-normal mb-2 border-b border-black/20 pb-1">Professional Experience</div>
        <div className="mb-2">
          <div className="text-xs md:text-sm font-medium">TechCorp Inc. | 2021 - Present</div>
        </div>
      </div>
