...
const features: {
	...
	{
		titleKey: "autoFillExtensionTitle",
		descKey: "autoFillExtensionDesc",
		href: "#",
	},
	...
	{
		titleKey: "trackingDashboardTitle",
		descKey: "trackingDashboardDesc",
		href: "#",
	},
];
		...
		<section className="w-full bg-[#F3F3F3] py-16 md:py-24">
			<div className="max-w-7xl mx-auto px-4 md:px-8">
				<div className="grid lg:grid-cols-[340px_1px_1.5fr] gap-x-0 items-stretch mb-10 md:mb-14">
					<h2 className="text-3xl font-normal text-black mb-4 lg:mb-0 pr-6 lg:pr-10">
						{t("everythingYouNeedHeading")}
					</h2>
				...
				<div className="rounded-xl overflow-hidden border border-black/10">
					<div className="grid sm:grid-cols-2 lg:grid-cols-4 divide-x divide-y divide-black/10">
						{features.map((f) => (
							<article
								key={f.titleKey}
								className="relative flex flex-col p-6 min-h-[140px]"
							>
								...
								<div className="text-black text-sm md:text-base mb-4 pb-8">
									{t(f.descKey)}
								</div>
								<a
									href={f.href}
